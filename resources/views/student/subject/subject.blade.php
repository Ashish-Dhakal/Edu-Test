...
@section('content_header_title', 'Explore Course')
@section('content_header_subtitle', 'Subject')
        ...
        <div class="row mt-4  w-75">
            <div class="col-md-12 ">
                <div class="card shadow-sm ">
                    <a href="{{route('test.index')}}" class="text-decoration-none text-dark">
                        <div class="d-flex align-items-center p-3">
                            ...
                            <img src="{{ asset('assets/icon-image/chevron-forward-outline.svg') }}" alt="Toggle Dropdown"
        ...
        <div class="tab-content " id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-all-course" role="tabpanel" aria-labelledby="all-course-tab"
                ...
                <div class="column mt-4">
                    <div class="col-md-6">
                        <div class="card shadow-sm ">
                            <a href="{{route('subject.detail')}}" class="text-decoration-none text-dark">
                                <div class="d-flex align-items-center p-3">
                                    <img src="https://edurev.gumlet.io/cdn_lib/v10/lib/img/explore/explr_clss.png?w=100&amp;dpr=2.0"
                                        class="img-fluid me-3" style="max-height: 50px;" alt="+2 Science">
                                    <div class="flex-grow-1  px-3">Physic</div>
                                    <img src="{{ asset('assets/icon-image/chevron-forward-outline.svg') }}"
                                        alt="Toggle Dropdown" style="width: 24px; height: 24px;">
                                </div>
                            </a>
                        </div>
                    </div>
